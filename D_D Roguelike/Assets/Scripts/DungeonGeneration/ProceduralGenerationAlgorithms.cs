...
public static class ProceduralGenerationAlgorithms
{
    ...
    {
        HashSet<Vector2Int> path = new HashSet<Vector2Int>(); //make the hashset

        path.Add(startPosition); //add the start position to the set
    ...
    public static List<BoundsInt> BinarySpacePartitioning(BoundsInt spaceToSplit, int minimumWidth, int minimumHeight) //BoundsInt represents a bounding box
    {
        ...
        while(roomsQueue.Count > 0)
        {
            ...
            {
                if(Random.value < 0.5f) //randomly decide whether to split horizontally or vertically
                {
